...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (_modules_accordion_accordion_js__WEBPACK_IMPORTED_MODULE_2__["accordions"].length > 0) {
    ...
    var _loop = function _loop(i) {
      var accordion = _modules_accordion_accordion_js__WEBPACK_IMPORTED_MODULE_2__["accordions"][i];
    ...
    for (var i = 0; i < _modules_accordion_accordion_js__WEBPACK_IMPORTED_MODULE_2__["accordions"].length; i++) {
      _loop(i);
    }
  } // Описание компании
